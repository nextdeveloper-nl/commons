...
(
    id             int unsigned auto_increment
        primary key,
    id_ref         char(32) collate utf8_bin                null,
    ...
    constraint roles_id_ref_unique
        unique (id_ref),
    constraint roles_name_owner_id_unique
        unique (name, owner_id),
    constraint roles_owner_id_foreign
        foreign key (owner_id) references plusclouds_v3.accounts (id)
            on delete set null
)
