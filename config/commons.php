...
return [
    ...
    'configuration' => [
        ...
        'system_user_email'   =>  env('SYSTEM_USER_EMAIL', 'leo@plusclouds.com'),
    ],
    ...
    */
    'external_services' => [
        ...
        [
            ...
            'description' => 'Google Contacts is a contact management tool developed by Google.',
            'status'      => env('GOOGLE_CONTACTS_SERVICE_STATUS', false),
            'scopes'      => [
