...
class AbstractStatesTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(States $model)
    {
    ...
    public function includeSocialMedia(States $model)
    {
    ...
    public function includeComments(States $model)
    {
    ...
    public function includeVotes(States $model)
    {
    ...
    public function includeMeta(States $model)
    {
    ...
    public function includePhoneNumbers(States $model)
    {
    ...
    public function includeAddresses(States $model)
    {
