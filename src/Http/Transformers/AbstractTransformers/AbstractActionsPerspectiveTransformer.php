...
class AbstractActionsPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(ActionsPerspective $model)
    {
    ...
    public function includeSocialMedia(ActionsPerspective $model)
    {
    ...
    public function includeComments(ActionsPerspective $model)
    {
    ...
    public function includeVotes(ActionsPerspective $model)
    {
    ...
    public function includeMeta(ActionsPerspective $model)
    {
    ...
    public function includePhoneNumbers(ActionsPerspective $model)
    {
    ...
    public function includeAddresses(ActionsPerspective $model)
    {
