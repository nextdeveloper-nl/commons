...
class AbstractAddressesTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(Addresses $model)
    {
    ...
    public function includeSocialMedia(Addresses $model)
    {
    ...
    public function includeComments(Addresses $model)
    {
    ...
    public function includeVotes(Addresses $model)
    {
    ...
    public function includeMeta(Addresses $model)
    {
    ...
    public function includePhoneNumbers(Addresses $model)
    {
    ...
    public function includeAddresses(Addresses $model)
    {
