...
class AbstractActionLogsTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(ActionLogs $model)
    {
    ...
    public function includeSocialMedia(ActionLogs $model)
    {
    ...
    public function includeComments(ActionLogs $model)
    {
    ...
    public function includeVotes(ActionLogs $model)
    {
    ...
    public function includeMeta(ActionLogs $model)
    {
    ...
    public function includePhoneNumbers(ActionLogs $model)
    {
    ...
    public function includeAddresses(ActionLogs $model)
    {
