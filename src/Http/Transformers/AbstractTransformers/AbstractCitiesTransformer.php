...
class AbstractCitiesTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(Cities $model)
    {
    ...
    public function includeSocialMedia(Cities $model)
    {
    ...
    public function includeComments(Cities $model)
    {
    ...
    public function includeVotes(Cities $model)
    {
    ...
    public function includeMeta(Cities $model)
    {
    ...
    public function includePhoneNumbers(Cities $model)
    {
    ...
    public function includeAddresses(Cities $model)
    {
