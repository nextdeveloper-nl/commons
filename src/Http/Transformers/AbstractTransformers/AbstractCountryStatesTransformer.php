...
class AbstractCountryStatesTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(CountryStates $model)
    {
    ...
    public function includeSocialMedia(CountryStates $model)
    {
    ...
    public function includeComments(CountryStates $model)
    {
    ...
    public function includeVotes(CountryStates $model)
    {
    ...
    public function includeMeta(CountryStates $model)
    {
    ...
    public function includePhoneNumbers(CountryStates $model)
    {
    ...
    public function includeAddresses(CountryStates $model)
    {
