...
class AbstractLanguagesTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(Languages $model)
    {
    ...
    public function includeSocialMedia(Languages $model)
    {
    ...
    public function includeComments(Languages $model)
    {
    ...
    public function includeVotes(Languages $model)
    {
    ...
    public function includeMeta(Languages $model)
    {
    ...
    public function includePhoneNumbers(Languages $model)
    {
    ...
    public function includeAddresses(Languages $model)
    {
