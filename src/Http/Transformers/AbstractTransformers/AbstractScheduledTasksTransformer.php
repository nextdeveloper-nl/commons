 ...
 */
class AbstractScheduledTasksTransformer extends AbstractTransformer
{
    ...
    public function includeStates(ScheduledTasks $model)
    {
    ...
    public function includeActions(ScheduledTasks $model)
    {
    ...
    public function includeMedia(ScheduledTasks $model)
    {
    ...
    public function includeSocialMedia(ScheduledTasks $model)
    {
    ...
    public function includeComments(ScheduledTasks $model)
    {
    ...
    public function includeVotes(ScheduledTasks $model)
    {
    ...
    public function includeMeta(ScheduledTasks $model)
    {
    ...
    public function includePhoneNumbers(ScheduledTasks $model)
    {
    ...
    public function includeAddresses(ScheduledTasks $model)
    {
