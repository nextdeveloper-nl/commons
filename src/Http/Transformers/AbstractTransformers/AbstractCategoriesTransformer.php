...
class AbstractCategoriesTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(Categories $model)
    {
    ...
    public function includeSocialMedia(Categories $model)
    {
    ...
    public function includeComments(Categories $model)
    {
    ...
    public function includeVotes(Categories $model)
    {
    ...
    public function includeMeta(Categories $model)
    {
    ...
    public function includePhoneNumbers(Categories $model)
    {
    ...
    public function includeAddresses(Categories $model)
    {
