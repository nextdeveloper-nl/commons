 ...
 */
class AbstractTaskSchedulersTransformer extends AbstractTransformer
{
    ...
    public function includeStates(TaskSchedulers $model)
    {
    ...
    public function includeActions(TaskSchedulers $model)
    {
    ...
    public function includeMedia(TaskSchedulers $model)
    {
    ...
    public function includeSocialMedia(TaskSchedulers $model)
    {
    ...
    public function includeComments(TaskSchedulers $model)
    {
    ...
    public function includeVotes(TaskSchedulers $model)
    {
    ...
    public function includeMeta(TaskSchedulers $model)
    {
    ...
    public function includePhoneNumbers(TaskSchedulers $model)
    {
    ...
    public function includeAddresses(TaskSchedulers $model)
    {
