...
class AbstractCountriesTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(Countries $model)
    {
    ...
    public function includeSocialMedia(Countries $model)
    {
    ...
    public function includeComments(Countries $model)
    {
    ...
    public function includeVotes(Countries $model)
    {
    ...
    public function includeMeta(Countries $model)
    {
    ...
    public function includePhoneNumbers(Countries $model)
    {
    ...
    public function includeAddresses(Countries $model)
    {
