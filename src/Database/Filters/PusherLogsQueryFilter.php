 ...
 */
class PusherLogsQueryFilter extends AbstractQueryFilter
{
    ...
    public function responseCode($value)
    {
        ...
        return $this->builder->where('response_code', $operator, $value);
    }

        //  This is an alias function of responseCode
    public function response_code($value)
    {
