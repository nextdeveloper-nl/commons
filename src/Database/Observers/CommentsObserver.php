...
class CommentsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\Comments', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\Comments', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\Comments', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\Comments', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\Comments', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\Comments', $model);
    }
