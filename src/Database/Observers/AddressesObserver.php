...
class AddressesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\Addresses', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\Addresses', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\Addresses', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\Addresses', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\Addresses', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\Addresses', $model);
    }
