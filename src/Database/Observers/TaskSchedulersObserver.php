...
class TaskSchedulersObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\TaskSchedulers', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\TaskSchedulers', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\TaskSchedulers', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\TaskSchedulers', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\TaskSchedulers', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\TaskSchedulers', $model);
    }
