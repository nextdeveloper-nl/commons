...
class KeywordsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\Keywords', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\Commons\Keywords', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\Keywords', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\Keywords', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\Commons\Keywords', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\Commons\Keywords', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\Keywords', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\Commons\Keywords', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\Keywords', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\Keywords', $model);
    }
