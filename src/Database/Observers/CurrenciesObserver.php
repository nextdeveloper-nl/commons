...
class CurrenciesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\Currencies', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\Currencies', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\Currencies', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\Currencies', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\Currencies', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\Currencies', $model);
    }
