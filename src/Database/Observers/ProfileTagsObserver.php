...
class ProfileTagsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\ActionLogs', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\ActionLogs', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\ActionLogs', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\ActionLogs', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\ActionLogs', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\ActionLogs', $model);
    }
