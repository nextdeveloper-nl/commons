...
class ValidatablesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\Validatables', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\Validatables', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\Validatables', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\Validatables', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\Validatables', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\Validatables', $model);
    }
