...
/**
 * Class DisposableEmailsObserver
 *
...
class DisposableEmailsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\DisposableEmails', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\DisposableEmails', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\DisposableEmails', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\DisposableEmails', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\DisposableEmails', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\DisposableEmails', $model);
    }
