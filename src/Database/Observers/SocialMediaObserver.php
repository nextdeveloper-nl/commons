...
class SocialMediaObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\SocialMedia', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\SocialMedia', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\SocialMedia', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\SocialMedia', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\SocialMedia', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\SocialMedia', $model);
    }
