...
/**
 * Class ActionsPerspectiveObserver
 *
...
class ActionsPerspectiveObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\ActionsPerspective', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\ActionsPerspective', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\ActionsPerspective', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\ActionsPerspective', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\ActionsPerspective', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\ActionsPerspective', $model);
    }
