...
class ActionsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\Actions', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\Actions', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\Actions', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\Actions', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\Actions', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\Actions', $model);
    }
