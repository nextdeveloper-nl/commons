...
class CitiesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\Cities', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\Cities', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\Cities', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\Cities', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\Cities', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\Cities', $model);
    }
