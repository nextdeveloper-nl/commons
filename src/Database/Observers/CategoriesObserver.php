...
class CategoriesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\Categories', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\Categories', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\Categories', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\Categories', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\Categories', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\Categories', $model);
    }
