...
class MediaObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\Media', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\Media', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\Media', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\Media', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\Media', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\Media', $model);
    }
