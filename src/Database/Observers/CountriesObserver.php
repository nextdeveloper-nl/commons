...
class CountriesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\Countries', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\Countries', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\Countries', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\Countries', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\Countries', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\Countries', $model);
    }
