...
/**
 * Class AvailableActionsObserver
 *
...
class AvailableActionsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\AvailableActions', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\AvailableActions', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\AvailableActions', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\AvailableActions', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\AvailableActions', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\AvailableActions', $model);
    }
