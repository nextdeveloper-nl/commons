...
class VotesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\Votes', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\Votes', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\Votes', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\Votes', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\Votes', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\Votes', $model);
    }
