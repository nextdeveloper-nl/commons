...
class PushersObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\Pushers', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\Commons\Pushers', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\Pushers', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\Pushers', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\Commons\Pushers', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\Commons\Pushers', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\Pushers', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\Commons\Pushers', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\Pushers', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\Pushers', $model);
    }
