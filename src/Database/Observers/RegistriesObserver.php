...
class RegistriesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\Registries', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\Registries', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\Registries', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\Registries', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\Registries', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\Registries', $model);
    }
