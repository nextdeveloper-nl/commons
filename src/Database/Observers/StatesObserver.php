...
class StatesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\Commons\States', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\Commons\States', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\Commons\States', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\Commons\States', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\Commons\States', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\Commons\States', $model);
    }
