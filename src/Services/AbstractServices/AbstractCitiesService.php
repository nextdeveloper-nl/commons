 ...
 */
class AbstractCitiesService
{
    public static function get(CitiesQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new CitiesQueryFilter($request);
        }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Cities
    {
    ...
    {
        $object = Cities::where('uuid', $objectId)->first();
     ...
     * @return Cities|null
     */
    public static function getById($id) : ?Cities
    {
    ...
    {
        try {
            $obj = Cities::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\Commons\Cities', $model);
     ...
     * @return Cities
     */
    public static function updateRaw(array $data) : ?Cities
    {
    ...
    {
        $model = Cities::where('uuid', $id)->first();
        ...
        Events::fire('updated:NextDeveloper\Commons\Cities', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\Commons\Cities', $model);
