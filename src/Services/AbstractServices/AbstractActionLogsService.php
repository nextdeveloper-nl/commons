 ...
 */
class AbstractActionLogsService
{
    public static function get(ActionLogsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new ActionLogsQueryFilter(new Request());
        }
        ...
        $model = ActionLogs::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?ActionLogs
    {
        return ActionLogs::findByRef($ref);
    }

    public static function getActions()
    {
        $model = ActionLogs::class;
     ...
     */
    public static function getById($id) : ?ActionLogs
    {
        return ActionLogs::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = ActionLogs::where('uuid', $uuid)->first();
