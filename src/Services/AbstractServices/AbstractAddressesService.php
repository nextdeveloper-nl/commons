    ...
    */
    public static function create(array $data) {
        event( new AddressCreatingEvent() );
                ...
                if (array_key_exists('addressable_id', $data))
            $data['addressable_id'] = DatabaseHelper::uuidToId(
                '\NextDeveloper\\Database\Models\Addressable',
                $data['addressable_id']
            );
	        if (array_key_exists('country_id', $data))
            $data['country_id'] = DatabaseHelper::uuidToId(
                '\NextDeveloper\\Database\Models\Country',
                $data['country_id']
            );
