...
class AbstractDomainablesService {
    ...
    */
    public static function create(array $data) {
        event( new DomainableCreatingEvent() );

                if (array_key_exists('domainable_id', $data))
            $data['domainable_id'] = DatabaseHelper::uuidToId(
                '\NextDeveloper\\Database\Models\Domainable',
                $data['domainable_id']
            );
...
return null;
    ...
    */
    public static function delete($id, array $data) {
        ...
        event( new DomainablesDeletedEvent($model) );
