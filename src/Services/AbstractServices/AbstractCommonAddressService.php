...
*/
class AbstractCommonAddressService {
    public static function get(CommonAddressQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator {
        ...
        */
        if($filter == null)
            $filter = new CommonAddressQueryFilter(new Request());
        ...
        $model = CommonAddress::filter($filter);
    ...
    * @return mixed
    */
    public static function getByRef($ref) : ?CommonAddress {
        return CommonAddress::findByRef($ref);
    }
    ...
    */
    public static function getById($id) : ?CommonAddress {
        return CommonAddress::where('id', $id)->first();
    }
    ...
    */
    public static function create(array $data) {
        ...
        event( new CommonAddressCreatedEvent($model) );
    ...
    */
    public static function update($id, array $data) {
        $model = CommonAddress::where('uuid', $id)->first();

        event( new CommonAddressesUpdateingEvent($model) );
        ...
        event( new CommonAddressesUpdatedEvent($model) );
    ...
    */
    public static function delete($id, array $data) {
        ...
        event( new CommonAddressesDeletingEvent() );
        ...
        event( new CommonAddressesDeletedEvent($model) );
