 ...
 *
 * Class CountryStatesService.
 *
 * @package NextDeveloper\Commons\Database\Models
 */
class AbstractCountryStatesService
{
    public static function get(CountryStatesQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
     ...
     *
     * @param  $id
     * @return CountryStates|null
     */
    public static function getById($id) : ?CountryStates
    {
        return CountryStates::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = CountryStates::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\Commons\CountryStates', $model);
     ...
     */
    public static function updateRaw(array $data) : ?CountryStates
    {
    ...
    public static function update($id, array $data)
    {
        ...
        Events::fire('updated:NextDeveloper\Commons\CountryStates', $model);
